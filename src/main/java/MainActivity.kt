...
package org.mozilla.appservices.structbug
...
public class MainActivity: Activity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val maybeNine = this.should_return_nine()

    val label = TextView(this);
    label.setText("Expected 9, got $maybeNine");

    setContentView(label);
  }

  fun should_return_nine(): Long {
    //
    ...
    // 
    return LIBRARY.INSTANCE.return_the_ninth_argument(
